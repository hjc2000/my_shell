...
recode-to-utf8.ps1 -input_file_path "$input_file_path/*.hpp" -Recurse
...
recode-to-utf8.ps1 -input_file_path "$input_file_path/*.json" -Recurse
recode-to-utf8.ps1 -input_file_path "$input_file_path/*.xml" -Recurse
